...
def enhance_life_history_data(species_title: str, stages: list[dict]):
    ...
    system_prompt = (
        ...
        "- Keep immature stages before adult or reproductive stages.\n"
        "- Resource-needs bullets must NOT determine stage order by themselves.\n"
        ...
        "- If resource-needs details are present, compress them into concise ecological meaning.\n"
        "- Prefer bullets like 'Resource focus: nesting cover, thermal shelter' instead of long raw field dumps.\n"
